...
# docker run --rm -it --name nginx hence/nginx
docker run --rm -it -e NGINX_APP_CHOWN_EXCLUSIONS_GLOB="*" -e NGINX_CONFIG_PRESET=drupal7 -e NGINX_PHP_RANCHER_SIDEKICK=0 --name nginx hence/nginx
