...
# docker run --rm -it -v /hence/projects/opseu/solr:/hence/solr/data -e CONFIG_PRESET=drupal/search_api/5.x -e CONFIG_PRESET_PATH=drupal -p 8983:8983 --name solr hence/solr
